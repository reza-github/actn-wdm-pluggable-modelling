...
This document also covers an analysis of the gap between current IETF drafts and the corresponding works in other standards bodies and industry. The lifecycle of a coherent pluggable including operators' approval, viability assessment to deployment and deployment is also covered.
...
1. This interface provides the control of host packet and optical functions. It provides these functions which can be decoupled such that there is no overlap between the optical and packet control functions.

2. The optical controller has read/write access to the optical network

3. The CMIS (content management interoperability services) communication interface between host packet devices) and optical pluggables
...
The characterizes of the Media Logical Channels are:
...
Note that purpose of this section is to clarify the coherent pluggable. This purpose of this draft is not to define the data model of the electrical channels.
